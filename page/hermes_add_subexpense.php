                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-7">
                                    ...
                                    <div class="row ml-2">
                                        <table class="table" id="display">
                                            ...
                                            <!-- <button type="button" class="btn btn-danger btn-sm btn-round"><i class="fa fa-trash-o"></i></button> -->
                                            <tbody id="detail">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="row justify-content-center mt-3">
                                        <button type="submit" class="btn btn-primary " data-toggle="modal" id="save_payment" data-target="#exampleModal">Save</button>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <label for="exampleInputEmail1">Please explain,why you need to
                                                        ...
                                                        remove this record (more than 10 characters)?</label>
